...
def test_batch_alist_hz(batch_size=10000, target_error=1000):
    decoder_yaml = 'examples/alist/bp_relay_hz.yaml'
...
def test_batch_txt_hx(batch_size=10000, target_error=1000):
    decoder_yaml = 'examples/txt/bp_relay_hx.yaml'
...
def test_batch_txt_hz(batch_size=10000, target_error=1000):
    # create decoder
    decoder_yaml = 'examples/txt/bp_relay_hz.yaml'
